...
Puedes cambiar tus preferencias de cookies en cualquier momento haciendo clic en "Gestionar cookies" en el pie de página del sitio. También puedes borrar las cookies desde la configuración de tu navegador, aunque esto puede afectar al funcionamiento de la plataforma.
...
You can change your cookie preferences at any time by clicking "Manage cookies" in the site footer. You can also delete cookies through your browser settings, although this may affect how the platform works.
