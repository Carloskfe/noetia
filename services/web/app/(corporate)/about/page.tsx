...
export const metadata: Metadata = {
  title: 'About Noetia — The Knowledge Expression Platform',
  description: 'Noetia created a new category: Knowledge Expression. Read about the mission, the vision, and the transformation that happens when reading becomes identity.',
  openGraph: { title: 'About Noetia', description: 'The first Knowledge Expression Platform — where reading, listening, and sharing converge to build a visible intellectual identity.' },
};
  ...
  return (
    <main>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 border-b border-gray-100">
        <SectionLabel>Sobre Noetia · About Noetia</SectionLabel>
        <div className="space-y-2 mb-8">
          <h1 className="text-5xl sm:text-6xl font-bold text-[#0D1B2A] leading-none">
            Leer siempre fue íntimo.
          </h1>
          <p className="text-3xl text-gray-400 font-light">Reading was always intimate.</p>
          <div className="h-4" />
          <p className="text-3xl font-bold text-[#0D1B2A]">Noetia lo convierte en identidad.</p>
          <p className="text-xl text-gray-400 font-light">Noetia turns it into identity.</p>
        </div>
        <PageCTA
          href="/register"
          label="Crear cuenta gratis"
          secondary={{ href: '/library', label: 'Explorar la biblioteca →' }}
        />
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 border-b border-gray-100">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
          <div>
            <SectionLabel>Misión · Mission</SectionLabel>
            <p className="text-[#0D1B2A] font-semibold text-lg leading-snug mb-2">
              Transformar el conocimiento que consumes en una identidad intelectual visible.
            </p>
            <p className="text-gray-400 text-base leading-relaxed italic">
              Transform the knowledge you consume into a visible intellectual identity.
            </p>
          </div>
          <div>
            <SectionLabel>Visión · Vision</SectionLabel>
            <p className="text-[#0D1B2A] font-semibold text-lg leading-snug mb-2">
              Un mundo donde el conocimiento es la moneda social más valiosa — y las personas más leídas son las más visibles.
            </p>
            <p className="text-gray-400 text-base leading-relaxed italic">
              A world where knowledge is the most valuable social currency — and the most well-read people are the most visible.
            </p>
          </div>
        </div>
      </section>
        ...
        <BiSection
          es={
            <>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 my-4">
                {['Leer', 'Escuchar', 'Resaltar', 'Anotar', 'Compartir', 'Construir identidad'].map((a) => (
          ...
          en={
            <>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 my-4">
                {['Read', 'Listen', 'Highlight', 'Annotate', 'Share', 'Build identity'].map((a) => (
                  <div key={a} className="bg-indigo-50 rounded-lg px-3 py-2 text-sm font-semibold text-indigo-700 text-center">{a}</div>
                ))}
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {VALUES.map(({ es, en }) => (
            <div key={es.title} className="border border-gray-100 rounded-xl p-6">
              ...
              <p className="text-gray-400 text-xs mb-3 italic">{en.title}</p>
          ...
          <BiSection
            es={
              <>
                ...
                <p>Esa decisión técnica abrió el resto. Cuando cada frase es una unidad sincronizada, puede ser guardada, compartida y atribuida con precisión. Cuando el fragmento es exacto, la expresión se vuelve legítima — no un resumen vago, sino la idea exacta, en las palabras exactas del autor.</p>
            ...
            en={
              <>
                ...
                <p>That technical decision opened everything else. When each phrase is a synchronized unit, it can be saved, shared, and attributed with precision. When the fragment is exact, expression becomes legitimate — not a vague summary, but the exact idea, in the author's exact words.</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <Link href="/company" className="group border border-gray-200 rounded-xl p-6 hover:border-indigo-300 transition">
            <p className="text-xs font-semibold uppercase tracking-widest text-indigo-500 mb-2">Empresa</p>
            <p className="font-bold text-[#0D1B2A] group-hover:text-indigo-600 transition">Cómo operamos →</p>
          </Link>
